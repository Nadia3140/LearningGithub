...
public class Home extends NavigationBar{
    ...
    private final By StartYearDropDown = By.id("start_year");
    ...
    public Home typeLoanAmount(String value)  {
        LOGGER.debug("Tying the loan amount: " + value);
    ...
    public Home validateTotalMonthlyPayment(String totalMonthlyPayment) {
        LOGGER.debug("Validate the total monthly payment is: " + totalMonthlyPayment);
